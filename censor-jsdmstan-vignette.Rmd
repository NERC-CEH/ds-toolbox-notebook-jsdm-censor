...
To fit this models as part of `jsdmstan` we utilize the connections between smoothers and Bayesian methods (see [Miller (2025)](https://doi.org/10.1111/2041-210X.14498) and references therein). We can write our flexible functions as a sum of basis functions:
